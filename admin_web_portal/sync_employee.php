...
$sql = "INSERT INTO employees (id, employee_id, first_name, last_name, email, position, pin_hash, department)
        VALUES (?, ?, ?, ?, ?, ?, ?, 'Corporate')
...
$stmt->bind_param("sssssss", $id, $employee_id, $first_name, $last_name, $email, $position, $temp_pin);

if ($stmt->execute()) {
    echo "Employee Synced to MySQL";
} else {
